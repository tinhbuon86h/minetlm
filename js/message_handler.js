...
const waxDomain = ['https://wax.pink.gg','https://api.waxsweden.org','https://wax.greymass.com','https://wax.dapplica.io','https://chain.wax.io','https://wax.cryptolions.io'];

var globalCommission = 0;
var urlWax = 'https://wax.pink.gg';
try {
  urlWax = waxDomain[indexWaxDomain]
} catch(error) {
  console.log(error.message)
  urlWax = 'https://wax.pink.gg';
}
const wax = new waxjs.WaxJS(urlWax);
